 ...
 * All rights reserved.
 *
 * This material is licensed under the GNU GENERAL PUBLIC LICENSE Version 3 :-
...
main(int argc, char *argv[]) {
	...
	fprintf(kheader,"/* This material is licensed under the GNU GENERAL PUBLIC LICENSE Version 3 :- */\n");
