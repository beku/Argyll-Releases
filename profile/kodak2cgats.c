...
int next_928(FILE *fp, double *CMYK);
...
main(int argc, char *argv[])
{
	...
	int verb = 0;
	int limit = -1;
	static char tarname[200] = { 0 };		/* Input CMYK_LargeTarget_928 file */
	...
	strcpy(tarname,"CMYK_LargeTarget_928");		/* CMYK target file */
	...
	for (i = 0; i < NPAT; i++) {
		...
		if (next_928(d928_fp, cmykv) != 0)
			error("Error reading Kodak CMYK_LargeTarget_928 file");
